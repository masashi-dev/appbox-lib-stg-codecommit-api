...
import jp.co.fnj.storage.api.service.sortorder.SortOrderLogicalNameSortService;
 ...
 */
@Service
public class SortOrderLogicalNameSortLogic<REQUEST_BODY extends SortOrderLogicalNameSortRequest, RESPONSE extends SortOrderLogicalNameSortResponse> {

  @Autowired
  private SortOrderLogicalNameSortService<REQUEST_BODY, RESPONSE> SortOrderLogicalNameSortService;
  ...
  private void innerExecute(HttpServletRequest request, HttpServletResponse response,
    ...
    try {
      // 各種サービスを順次実行
      SortOrderLogicalNameSortService.execute(request, response, requestBody);
