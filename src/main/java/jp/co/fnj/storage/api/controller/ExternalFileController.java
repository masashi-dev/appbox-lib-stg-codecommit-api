...
import jp.co.fnj.storage.constant.StorageApiUrl;
...
import jp.co.fnj.storage.model.externalfile.ExternalFileGetRequest;
import jp.co.fnj.storage.model.externalfile.ExternalFileGetResponse;
import jp.co.fnj.storage.model.externalfile.ExternalFileRegistRequest;
import jp.co.fnj.storage.model.externalfile.ExternalFileRegistResponse;
...
public class ExternalFileController {
	   ...
	   @Autowired
	    ...
	    @ResponseBody
	    public ResponseEntity<ExternalFileGetResponse> get(
	            HttpServletRequest request,
	            HttpServletResponse response,
	            @RequestBody ExternalFileGetRequest requestBody
	    ) throws StorageException {
	    ...
	    @ResponseBody
	    public ResponseEntity<ExternalFileRegistResponse> regist(
	            HttpServletRequest request,
	            HttpServletResponse response,
	            @RequestBody ExternalFileRegistRequest requestBody
	    ) throws StorageException {
	    ...
	    @ResponseBody
	    public ResponseEntity<ExternalFileDeleteResponse> delete(
	            HttpServletRequest request,
	            HttpServletResponse response,
	            @RequestBody ExternalFileDeleteRequest requestBody
	    ) throws StorageException {
