...
@Slf4j
public class AppboxPlatformWebApiExceptionHandler extends ResponseEntityExceptionHandler {

    
//    @Autowired
//    private AppboxPlatformMessageSource messageSource;
//    
//    
//    /**
//     * API呼び出し時の例外
...
//     * @return
//     */
//    @ExceptionHandler(AppboxPlatformApiClientException.class)
...
//     * @return
//     */
//    @ExceptionHandler(AppboxPlatformWebBadRequestException.class)
//    public ResponseEntity<Object> handleWebBadRequestException(AppboxPlatformWebBadRequestException ex, WebRequest request) {
//        // ログを出力する
//        log.debug(ex.getMessage(), ex);
//        
